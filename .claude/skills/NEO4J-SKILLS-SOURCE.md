...
| `neo4j-cypher-skill` | 1.0.24 | Write, optimise and validate Cypher 25 queries (Neo4j 2025.01+) |
...
To update: re-copy the skill directories from a newer commit of the source repo and bump the pinned commit above.
